    ...
    String path="";   
     ...
     public String getCurrentPath()   {
               ...
               Map m1 = new HashMap(); 
                     ...
                     m1.put("/Portal_Pages/AboutCourt.jspx", "عن المحكمة/ التعريف بالمحكمة");
                     m1.put("/Portal_Pages/CourtHistory.jspx", "عن المحكمة/ لمحة تاريخة");
                     m1.put("/Portal_Pages/CourtBuilding.jspx", "عن المحكمة/ مبنى المحكمة");
                     m1.put("/Portal_Pages/Galary.jspx", "عن المحكمة/ البوم الصور");
                     m1.put("/Portal_Pages/Judjements_Search.jspx", "الأحكام الدستورية/ بحث الاحكام");
                     m1.put("/Portal_Pages/CourtRules.jspx", "الأحكام الدستورية/ أحكام المحكمة الدستورية");
                     m1.put("/Portal_Pages/HighCourtRules.jspx", "الأحكام الدستورية/ أحكام المحكمة العليا");
                     m1.put("/Portal_Pages/LawsSearch.jspx", "الأحكام الدستورية/بحث موضوعي/ بحث بدلالة التشريعات");
                     m1.put("/Portal_Pages/GroupesSearch.jspx", "الأحكام الدستورية/بحث موضوعي/ بحث بدلالة المجموعات");
                   //////
                   m1.put("/Portal_Pages/CourtRollMofwadeen.jspx", "الجلسات/ جلسات هيئة المفوضين");
                   m1.put("/Portal_Pages/CourtRoll.jspx", "الجلسات/ جلسات المحكمة");
                   m1.put("/Portal_Pages/SearchRolls.jspx","الجلسات/ بحث/جلسات المحكمة");
                   m1.put("/Portal_Pages/SearchRollMofwadeen.jspx","الجلسات/ بحث/جلسات المحكمة");
                   m1.put("/Portal_Pages/Court_Members_Current.jspx", "أعضاء الحكمة/ تشكيل الحكمة الدستورية");
                   m1.put("/Portal_Pages/CurrentMofwaddeenChairmen.jspx", "أعضاء المحكمة/ تشكيل هيئة المفوضين/ رؤساء");
                   //////////////////////////////
                   m1.put("/Portal_Pages/CourtChairmenPrevious.jspx", "أعضاء المحكمة/تشكيلات سابقة/ رؤساء الدستورية");
                   m1.put("/Portal_Pages/CourtChairmenRepresentativePrevious.jspx", "أعضاء المحكمة/تشكيلات سابقة/نواب رؤساء الدستورية");
                   m1.put("/Portal_Pages/MofwadeenChairmenPrevious.jspx", "أعضاء المحكمة/تشكيلات سابقة/رؤساء هيئة المفوضين");
                   m1.put("/Portal_Pages/MofwadeenMembersPrevious.jspx", "أعضاء المحكمة/تشكيلات سابقة/أعضاء هيئة المفوضين");
                   m1.put("/Portal_Pages/TimeLine.jspx","أعضاء المحكمة/ عرض زمني");
                   m1.put("/Portal_Pages/Dostors.jspx", "الوثائق الدستورية");
                   m1.put("/Portal_Pages/PreviosControl.jspx", "الوثائق الدستورية/رقابة سابقة");
                   m1.put("/Portal_Pages/Magala.jspx", "المجلة/ اعدادالمجلة");
                   m1.put("/Portal_Pages/Makalat.jspx", "المجلة/ بحوث ومقالات");
                   m1.put("/Portal_Pages/Search_Magala.jspx", "المجلة/ بحث في المجلة");
                   m1.put("/Portal_Pages/search_case.jspx", "الدعاوى/ بحث الدعاوى");
                   m1.put("/Portal_Pages/CasesGalasat.jspx", "الدعاوى/ طرف الجلسات");
                   m1.put("/Portal_Pages/CasesMofwadeen.jspx", "الدعاوى/ طرف المفوضين");
                   m1.put("/Portal_Pages/Cases_Gadwal.jspx", "الدعاوى/ طرف الجدول");
                   //////////////
                   m1.put("/Portal_Pages/UnderConstruction.jspx", "تحت التنفيذ");
